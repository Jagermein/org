:PROPERTIES:
:ID:       fb2331f7-bcf2-4e21-9387-de8371c8c3dc
:END:
...
** aircraft
:PROPERTIES:
:ID:       ecb85eeb-4e60-4b42-ab6b-6c11153b8dd7
:END:
...
- side [string] : side number, unique for SQDN's but differing SQDN's can have the same side numbers.
...
** MarkerType
:PROPERTIES:
:ID:       59bc3a5e-a399-4187-bd81-267df8580f0a
:END:
